...
export default function RoomPage() {
  ...
  return (
    <main className="relative h-screen sm:max-h-screen sm:overflow-y-auto">
      <div className="m-6 mt-9 md:mt-12">
        <AnimatePresence>
          {room.flippedTimes > 3 && (
        ...
        {name ? (
          <div className="flex flex-col lg:flex-row justify-center gap-8 pt-4 pb-14 sm:pb-20 w-full h-full">
            {/* Members In The Room */}
              ...
              <div className="flex flex-col gap-2 md:gap-4">
                <div className="flex gap-2 md:gap-4">
                  <Button
                    ...
                    onClick={() => thinking()}
                  >
                    Thinking <code className="hidden md:inline">T</code>
                  </Button>
                  <Button
                    className="grow h-10 md:h-16 flex-1/2 md:text-xl"
                  ...
                  >
                    Confirm
                    <code className="hidden md:inline">C / Enter</code>
                  </Button>
                </div>
                <Button
                  ...
                  onClick={() => flipCards()}
                >
                  Flip Cards <code className="hidden md:inline">F</code>
                </Button>
                <Button disabled={!room?.flipped} onClick={() => restart()} className="h-10 md:h-16 md:text-xl">
                  Restart <code className="hidden md:inline">R</code>
                </Button>
              </div>
